...
const Home = () =>{
  return(
   ...
   <header>
    ...
    <main>
      <h1>Testando uma div</h1>
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta dolorum molestiae, ducimus, voluptatum quibusdam, omnis sunt hic obcaecati fugit laborum doloremque deserunt. Tempore maxime eveniet autem necessitatibus, quae voluptatem beatae!
